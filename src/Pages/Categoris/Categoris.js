...
const Categoris = () => {
  ...
  const { data: allCategorys = [], refetch } = useQuery({
    ...
    queryFn: () =>
      fetch(
        `https://resale-market-server-taupe.vercel.app/allCategory/?category=${category.category}`
      ).then((res) => res.json()),
  });
  ...
  return (
    <div className="w-10/12 mx-auto">
      <div className="flex justify-start">
        <h3 className="text-2xl font-bold rounded text-center text-white p-2 px-10 bg-orange-500 inline my-5">
